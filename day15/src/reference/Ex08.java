...
//		System.out.println((int)'e');
		...
		System.out.println("myCompareTo(s1, s2) : " + myCompareTo(s1, s3));
	...
	static int myCompareTo(String s1, String s2) {
		...
		// 두 문자열 길이가 다르다면 작은 길이만큼 반복해야 한다.
