...
public class Ex02 {
	public static void main(String[] args) {
		...
		int[] arr4 = new int[5];			// 배열 length는 총 5개 
...
//		int[] arr5 = new int[5] { 1, 2, 3, 2, 1 }; // 문법 틀림
		...
		// java.util.Arrays 클래스의 toString() 함수를 이용하여 변환 후 출력 할수있다.
		System.out.println("arr4 : " + Arrays.toString(arr4));
		
		arr4[0] = 11;		// 배열이름에 []를 붙히고 안에 index를 적어준다
...
//		arr4[5] = -1;		Index 5 out of bounds for length 5 at array
