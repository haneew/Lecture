...
class Test{
	// 멤버필드에 초기값을 지정하지 않으면 0에 맞는 값으로 자동으로 초기화된다.
	int num;
	...
	// 생성자도 함수이므로, 오버로딩(이름이 같지만, 매개변수 형태가 다른 함수의 중복정의)이 가능하다
	Test(){
...
public class Ex06 {
	public static void main(String[] args) {
		...
		*/
		...
		// Scanner 클래스는 객체를 생성하기 위해서, InputStream혹은 String 혹은 File등을 전달해야 한다
