...
public class Ex07 {
	public static void main(String[] args) throws IOException {
		...
		// 그에 맞는 클래스를 작성하기 번거로울떄 (사용빈도가 낮아서)
		// 클래스를 작성하는 대신, Map에 저장하여 한번에 전달하는 용도로도 사용한다 (제법 많이 사용함)
		
		
	}
}

//		Hash# : 값의 고유성을 보장하기 위해서 데이터를 일정한 식으로 분해해서 만들어낸 데이터의 파편
//		map : 순서상관 없이 여러 객체를 한번에 묶어서 보내고 싶을때 (질의응답에 특화되어있다) 
