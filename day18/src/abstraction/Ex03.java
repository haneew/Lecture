...
abstract class Test3{		// 추상 클래스, 객체화 할 수 없다
	void function1() {		// 일반 메서드를 포함할 수 없다.(추상메서드도 포함할 수 있다.)
	...
	// 추상메서드 function2를 포함하는 클래스 Test3는 추상클래스가 되어야 합니다.
}

class Sub extends Test3 { 	// 추상 클래스를 상속받는 클래스 Sub
	@Override
	void function2() {
...
public class Ex03 {
	public static void main(String[] args) {
		// 실제 객체를 코드에 반영할 떄는 작성자의 시점/관점에 따라 필요한 부분만 반영하게 된다.
