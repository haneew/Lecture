package exception;			// 다섯개 구문 다 알고 숙달되야 한다.
...
public class Ex05 {
	public static void main(String[] args) throws IOException {
		...
		//			이때, 순서는 상세한 것부터 포괄적인 예외순으로 작성해야 한다.
		//			맨 아래애 catch(Exception e)를 작성하면 모든 예외에 대한 처리가 된다
		...
		// 주고, 입출력 및 네트워크 통신에 관련된 예외는 반드시 예외처리를 선행해야 하는 경우가 있다.
